...
const target = `                  {isMe && (
                    <button onClick={() => setReplyingTo(msg)} className="opacity-100 md:opacity-0 md:group-hover:opacity-100 p-3 -mx-2 text-[#a0aec0] hover:text-[#FF6B6B] active:bg-gray-100 rounded-full transition-all">
                      <Reply size={16} />
                    </button>
                  )}`;
